...
`TakePhoto`是一款用于在Android设备上获取照片（拍照或从相册、文件中选择）、裁剪图片、压缩图片的开源工具库，目前最新版本[2.0.3](https://github.com/crazycodeboy/TakePhoto/)。  
...
```groovy
    compile 'com.jph.takephoto:takephoto_library:2.0.3'
```
